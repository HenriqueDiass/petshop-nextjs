        ...
        <section className="bg-amber-300 py-16">
            <div className="container mx-auto px-4">
                ...
                <div className="relative max-w-4xl mx-auto">
                        ...
                        <div className='flex'>
                            {testimonials.map((item, index) => (
                                <div key={index} className='flex-[0_0_100%] min-w-0 px-3'>
                                    ...
                                    <article className="bg-[#E84C3D] text-white rounded-2xl p-6 space-y-4 h-full flex flex-col">
                                        <div className='flex flex-col items-center text-center space-y-4'>
                                            ...
                                            <div>
                                                <p className='text-white-200'>{item.content}</p>
                                                <div>
                    ...
                    <button onClick={scrollNext} className='bg-white flex items-center justify-center rounded-full shadow-lg w-10 h-10 absolute -right-7 -translate-y-1/2 -translate-x-1/2 top-1/2 z-10'>
